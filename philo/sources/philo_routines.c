...
/*   Updated: 2022/01/13 22:40:07 by lorphan          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	pthread_mutex_lock(&table_info->forks[philo.left_id - 1]);
	pthread_mutex_lock(&table_info->forks[philo.right_id - 1]);
	...
	pthread_mutex_unlock(&table_info->forks[philo.left_id - 1]);
	pthread_mutex_unlock(&table_info->forks[philo.right_id - 1]);
}
